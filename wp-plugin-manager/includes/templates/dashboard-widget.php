...
<?php
$info_data = HTPM_Api::get_remote_data();
        ...
        <ul>
            <li>
                <a href="https://hasthemes.com/blog/" target="_blank">
                    <?php esc_html_e( 'Blog', 'wp-plugin-manager' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/docs/wp-plugin-manager/" target="_blank">
                    <?php esc_html_e( 'Documentation', 'wp-plugin-manager' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/contact-us/" target="_blank">
                    <?php esc_html_e( 'Support', 'wp-plugin-manager' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
        </ul>
